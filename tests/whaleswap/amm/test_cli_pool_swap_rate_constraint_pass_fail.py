...
def test_pool_swap_rate_constraint_pass_fail(chainnet, ws_setup_env):
    dysond = chainnet[0]
    env = ws_setup_env
    ...
    # PASS: legs with swap_in 10a, swap_out 9b (achievable)
    ...
    # FAIL: swap_in 10a with swap_out 11b (unachievable) should fail with keeper error
    leg_fail = {
        "pool_id": pid,
        "swap_in": {"denom": a, "amount": "10"},
