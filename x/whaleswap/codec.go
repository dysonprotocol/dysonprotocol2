...
func RegisterInterfaces(registrar codectypes.InterfaceRegistry) {
	registrar.RegisterImplementations((*sdk.Msg)(nil),
		...
		&types.MsgOpenPosition{},
		&types.MsgClosePosition{},
		&types.MsgAddCollateral{},
		&types.MsgRemoveCollateral{},
		&types.MsgCoverPosition{},
		&types.MsgInitializeLiquidation{},
		&types.MsgFinalizeLiquidation{},
	...
	registrar.RegisterImplementations(
		...
		&types.MsgOpenPositionResponse{},
		&types.MsgClosePositionResponse{},
		&types.MsgAddCollateralResponse{},
		&types.MsgRemoveCollateralResponse{},
		&types.MsgCoverPositionResponse{},
		&types.MsgInitializeLiquidationResponse{},
		&types.MsgFinalizeLiquidationResponse{},
