...
var _ protoreflect.List = (*_AddressMetrics_35_list)(nil)

type _AddressMetrics_35_list struct {
	list *[]*v1beta1.Coin
}

func (x *_AddressMetrics_35_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_AddressMetrics_35_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_AddressMetrics_35_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_AddressMetrics_35_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_AddressMetrics_35_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_AddressMetrics_35_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_AddressMetrics_35_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_AddressMetrics_35_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_AddressMetrics_profit                protoreflect.FieldDescriptor
	fd_AddressMetrics_losses                protoreflect.FieldDescriptor
...
func init() {
	...
	fd_AddressMetrics_profit = md_AddressMetrics.Fields().ByName("profit")
	fd_AddressMetrics_losses = md_AddressMetrics.Fields().ByName("losses")
...
func (x *fastReflection_AddressMetrics) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Profit) != 0 {
		value := protoreflect.ValueOfList(&_AddressMetrics_33_list{list: &x.Profit})
		if !f(fd_AddressMetrics_profit, value) {
			return
		}
	}
	if len(x.Losses) != 0 {
		value := protoreflect.ValueOfList(&_AddressMetrics_35_list{list: &x.Losses})
		if !f(fd_AddressMetrics_losses, value) {
			return
		}
	}
...
func (x *fastReflection_AddressMetrics) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "dysonprotocol.whaleswap.v1.AddressMetrics.profit":
		return len(x.Profit) != 0
	case "dysonprotocol.whaleswap.v1.AddressMetrics.losses":
		return len(x.Losses) != 0
...
func (x *fastReflection_AddressMetrics) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "dysonprotocol.whaleswap.v1.AddressMetrics.profit":
		...
		listValue := &_AddressMetrics_33_list{list: &x.Profit}
		return protoreflect.ValueOfList(listValue)
	case "dysonprotocol.whaleswap.v1.AddressMetrics.losses":
		if len(x.Losses) == 0 {
			return protoreflect.ValueOfList(&_AddressMetrics_35_list{})
		}
		listValue := &_AddressMetrics_35_list{list: &x.Losses}
		return protoreflect.ValueOfList(listValue)
	case "dysonprotocol.whaleswap.v1.AddressMetrics.liquidations":
...
func (x *fastReflection_AddressMetrics) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "dysonprotocol.whaleswap.v1.AddressMetrics.losses":
		lv := value.List()
		clv := lv.(*_AddressMetrics_35_list)
		x.Losses = *clv.list
	case "dysonprotocol.whaleswap.v1.AddressMetrics.liquidations":
...
func (x *fastReflection_AddressMetrics) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "dysonprotocol.whaleswap.v1.AddressMetrics.profit":
		...
		value := &_AddressMetrics_33_list{list: &x.Profit}
		return protoreflect.ValueOfList(value)
	case "dysonprotocol.whaleswap.v1.AddressMetrics.losses":
		if x.Losses == nil {
			x.Losses = []*v1beta1.Coin{}
		}
		value := &_AddressMetrics_35_list{list: &x.Losses}
		return protoreflect.ValueOfList(value)
	case "dysonprotocol.whaleswap.v1.AddressMetrics.maker_volume":
...
func (x *fastReflection_AddressMetrics) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "dysonprotocol.whaleswap.v1.AddressMetrics.losses":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_AddressMetrics_35_list{list: &list})
	case "dysonprotocol.whaleswap.v1.AddressMetrics.liquidations":
		return protoreflect.ValueOfUint64(uint64(0))
	case "dysonprotocol.whaleswap.v1.AddressMetrics.offers_created":
		return protoreflect.ValueOfUint64(uint64(0))
...
func (x *fastReflection_AddressMetrics) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.Profit) > 0 {
			for _, e := range x.Profit {
				l = options.Size(e)
				n += 2 + l + runtime.Sov(uint64(l))
			}
		}
		if len(x.Losses) > 0 {
			for _, e := range x.Losses {
				l = options.Size(e)
				n += 2 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Losses) > 0 {
			for iNdEx := len(x.Losses) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.Losses[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
		...
		if len(x.Profit) > 0 {
			for iNdEx := len(x.Profit) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.Profit[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 33:
				...
				x.Profit = append(x.Profit, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.Profit[len(x.Profit)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 35:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Losses", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.Losses = append(x.Losses, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.Losses[len(x.Losses)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 34:
...
type AddressMetrics struct {
	...
	Profit []*v1beta1.Coin `protobuf:"bytes,33,rep,name=profit,proto3" json:"profit,omitempty"`
	// Losses from closed leverage positions (denoms with metadata only)
	Losses []*v1beta1.Coin `protobuf:"bytes,35,rep,name=losses,proto3" json:"losses,omitempty"`
...
func (x *AddressMetrics) GetProfit() []*v1beta1.Coin {
	if x != nil {
		return x.Profit
	}
	return nil
...
func (x *AddressMetrics) GetLosses() []*v1beta1.Coin {
	if x != nil {
		return x.Losses
	}
	return nil
...
var file_dysonprotocol_whaleswap_v1_whaleswap_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x0a, 0x66, 0x65, 0x65, 0x73, 0x45, 0x61, 0x72, 0x6e, 0x65, 0x64, 0x22, 0xcf, 0x0c,
	...
	,
...
var file_dysonprotocol_whaleswap_v1_whaleswap_proto_depIdxs = []int32{
	...
	6,  // 44: dysonprotocol.whaleswap.v1.AddressMetrics.profit:type_name -> cosmos.base.v1beta1.Coin
	6,  // 45: dysonprotocol.whaleswap.v1.AddressMetrics.losses:type_name -> cosmos.base.v1beta1.Coin
	6,  // 46: dysonprotocol.whaleswap.v1.AddressMetrics.maker_volume:type_name -> cosmos.base.v1beta1.Coin
	6,  // 47: dysonprotocol.whaleswap.v1.AddressMetrics.auction_volume:type_name -> cosmos.base.v1beta1.Coin
