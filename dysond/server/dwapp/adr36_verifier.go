...
// address, the app_domain, the raw data string, and the metadata string from the first message.
func VerifyADR36TxJSON(ctx context.Context, clientCtx client.Context, txJSON string) (string, string, string, string, error) {
	...
	// Parse app_domain, data, and metadata fields from the first message
	...
	return resp.Signer, msg.AppDomain, msg.Data, msg.Metadata, nil
}
