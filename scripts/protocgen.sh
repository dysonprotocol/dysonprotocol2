...
mkdir -p ./client/ts-client

# Generate for all proto files including external dependencies
echo "Generating TypeScript for all proto files (including external dependencies)..."
buf generate --template ./proto/buf.gen.es.yaml --include-imports
