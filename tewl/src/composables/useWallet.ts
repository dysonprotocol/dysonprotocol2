...
export function useWallet() {
  ...
  const sendMsg = async ({
    ...
    if (typeof gasLimit === "number") {
      ...
      // Keplr handles simulation automatically, use a high ceiling
      // Keplr will simulate and adjust the gas before signing
      finalGasLimit = GAS_CEILING;
    } else {
      // Non-Keplr wallets: simulate first to estimate gas
