...
replace (
	...
	// unify libp2p to single module to avoid ambiguous imports
	github.com/libp2p/go-libp2p/core => github.com/libp2p/go-libp2p v0.44.0
...
replace cosmossdk.io => ./cosmos-sdk
...
replace cosmossdk.io/types => ./cosmos-sdk/types

replace github.com/cosmos/cosmos-sdk/x/group => cosmossdk.io/x/group v0.2.0-rc.1

replace github.com/cometbft/cometbft => github.com/cometbft/cometbft v0.38.18
